package com.drypted.quicksearch.client.core.actions;

import com.drypted.quicksearch.client.QuickSearchClient;
import com.drypted.quicksearch.client.core.blueprints.actions.Action;
...
public class ReplaceInventoryItemAction extends Action
{
    public static void run(LocalPlayer player, @Nullable ItemStack stack, String displayName, int slotIndex)
    {
        ...
        if (QuickSearchClient.getConfig().notifications.showReplace)
        {
