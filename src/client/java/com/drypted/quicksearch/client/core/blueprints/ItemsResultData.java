package com.drypted.quicksearch.client.core.blueprints;

import com.drypted.quicksearch.client.core.blueprints.search.Searchable;
...
public final class ItemsResultData implements Searchable
{
    ...
    public static final ItemsResultData EMPTY = new ItemsResultData(
            ItemStack.EMPTY,
            "",
            Identifier.fromNamespaceAndPath("quicksearch", "search_result_data_empty")
    );
