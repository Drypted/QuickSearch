...
{
    @Override
    public boolean isNotNone() { return this.severity != InputFeedbackType.NONE && !this.equals(NO_ERROR); }
    ...
    @Override
    public InputFeedbackType getSeverity() { return severity; }
