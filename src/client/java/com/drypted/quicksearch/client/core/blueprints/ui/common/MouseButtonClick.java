...
public record MouseButtonClick(double x, double y, int button)
{
    ...
    public static MouseButtonClick from(double x, double y) { return new MouseButtonClick(x, y, 0); }

    public static MouseButtonClick from(double x, double y, int button) { return new MouseButtonClick(x, y, button); }
}
