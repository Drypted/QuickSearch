                             ...
                             boolean bottomRight)
{
    ...
    public static RoundedCorners fromSingle(boolean all) { return RoundedCorners.from(all, all, all, all); }

    public static RoundedCorners fromVerticalSides(boolean top, boolean bottom)
    {
        return RoundedCorners.from(
                top,
                top,
                bottom,
                bottom
    ...
    public static RoundedCorners all() { return RoundedCorners.from(true, true, true, true); }

    public static RoundedCorners none() { return RoundedCorners.from(false, false, false, false); }

    public boolean isNone() { return !topLeft && !topRight && !bottomLeft && !bottomRight; }

    public boolean isAll() { return topLeft && topRight && bottomLeft && bottomRight; }
}