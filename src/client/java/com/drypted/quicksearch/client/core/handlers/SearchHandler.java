...
import com.drypted.quicksearch.client.core.search.SimpleSearch;
import com.drypted.quicksearch.client.core.search.SmartSearch;
...
{
    private static final Supplier<Integer> MAX_RESULTS_SUPPLIER = () -> QuickSearchClient.getConfig().search.maxResults;
    private static final Supplier<SearchMode> SEARCH_MODE_SUPPLIER = () -> //
            QuickSearchClient.getConfig().search.fuzzySearch ? SearchMode.SMART : SearchMode.SIMPLE;
