...
{
    private static final Color THEME_BLACK = Color.fromInt(0xFF090C08)
                                                  .withHalfAlpha();                  // Onyx
    private static final Color THEME_WHITE = Color.fromInt(0xFFF7F7FF);           // Ghost White
    ...
    public static final class Hotbar
    {
        ...
        public static final Color SLOT_FOCUSED_COLOR = Styles.TERTIARY_COLOR;
        public static final Color SLOT_HIGHLIGHTED_COLOR = Styles.PRIMARY_COLOR;
        // hotbar help text
    ...
    public static final class ResultData
    {
        ...
        public static final Color TEXT_COLOR = Styles.THEME_WHITE;
        // indicators
        public static final Color HOVER_OUTLINE_COLOR = Styles.TERTIARY_COLOR;
