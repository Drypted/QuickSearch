...
public final class SpotlightResultPresenter
{
    private static final int HOTBAR_SLOTS = 9;

    private final InputWidget inputWidget;
    private final ScrollBoxWidget searchResultsWidget;
    private final SpotlightVisibilityController visibilityController;
    ...
    public SpotlightResultPresenter(InputWidget inputWidget, ScrollBoxWidget searchResultsWidget, SpotlightVisibilityController visibilityController, SpotlightViewState viewState, Consumer<ItemsResultData> onItemClicked, Consumer<Command> onCommandClicked, Consumer<String> onArgSuggestionClicked)
    {
