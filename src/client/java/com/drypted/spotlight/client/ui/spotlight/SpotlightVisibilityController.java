...
public final class SpotlightVisibilityController
{
    ...
    public SpotlightVisibilityController(InputWidget inputWidget, ScrollBoxWidget searchResultsWidget, @Nullable HotbarCollectionWidget hotbarCollectionWidget, BooleanSupplier isHotbarEnabled)
    {
